...
if ($_POST['txtAuthors']!="" OR $_POST['txtStation']!="" OR $_POST['txtDomain']!="" OR
    ...
    //----------------------------------------------------------------------------------------------------------------------
    if ($_POST['txtAuthors']!="") {
        $searchCriteria=$searchCriteria . "&author=" . $_POST['txtAuthors'];
        $_SESSION['txtAuthors']= $_POST['txtAuthors'];
    }
    if ($_POST['txtStation']!="") {
        $searchCriteria=$searchCriteria . "&station=" . $_POST['txtStation'];
        $_SESSION['txtStation']= $_POST['txtStation'];
    }
    if ($_POST['txtDomain']!="") {
        $searchCriteria=$searchCriteria . "&genre=" . $_POST['txtDomain'];
        $_SESSION['txtDomain']= $_POST['txtDomain'];
    }
    if ($_POST['txtDistributor']!="") {
        $searchCriteria=$searchCriteria . "&distributor=" . $_POST['txtDistributor'];
        $_SESSION['txtDistributor']= $_POST['txtDistributor'];
    }
    if ($_POST['txtLong']!="") {
        $searchCriteria=$searchCriteria . "&lon=" . $_POST['txtLong'];
        $_SESSION['txtLong']= $_POST['txtLong'];
    }
    if ($_POST['txtLat']!="") {
        $searchCriteria=$searchCriteria . "&lat=" . $_POST['txtLat'];
        $_SESSION['txtLat']= $_POST['txtLat'];
    }
    if ($_POST['txtFrom']!="") {
        $searchCriteria=$searchCriteria . "&year_from=" . $_POST['txtFrom'];
        $_SESSION['txtFrom']= $_POST['txtFrom'];
    }
    if ($_POST['txtTo']!="") {
        $searchCriteria=$searchCriteria . "&year_to=" . $_POST['txtTo'];
        $_SESSION['txtTo']= $_POST['txtTo'];
    }
    //----------------------------------------------------------------------------------------------------------------------
